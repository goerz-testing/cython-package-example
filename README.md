...
The ideas and concepts implemented here are discussed below.

## Usage

Run `make` or `tox -av` for an overview of available development/packaging tasks

# Guidelines for Packaging and Testing of Cython Packages
...
The virtual test environments are set up in the `tox.ini` file:
